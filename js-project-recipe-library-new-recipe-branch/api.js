...
const URL = `https://api.spoonacular.com/recipes/random?number=20&apiKey=${YOUR_API_KEY}`; // Fetch 4 recipes
let recipes = [];
...
const handleRecipeData = (recipe) => {
    ...
    recipeCard.innerHTML = `
        ...
        <p class="cuisine"><strong>Cuisine:</strong> ${cuisines || 'Unknown'}</p>
        <p class="details">
        ...
        <p class="details">
            <span class="bold">This dish is: </span>${recipe.veryPopular ? "Popular" : "Not very Popular"}
        </p>
        <hr />
...
// Call randomize to attach event listener  if i choose to fetch 20 the random btn stops working